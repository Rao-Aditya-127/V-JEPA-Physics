...
Near-ceiling R² hides one real change: the unexplained variance **halves between
layers 4 and 8**, the depth of the paper's "Physics Emergence Zone". Speed doesn't
emerge there, but its representation is refined there.
...
Additional checks that go beyond the brief (controls, the patch embedding, and where
the readout fails) are in [Appendix B](#appendix-b-additional-checks-beyond-the-brief).
...
To add the Appendix B checks to an existing run, without re-running it:

```bash
python scripts/02_layerwise_probe.py --variable speed --conditions embedding random_cv shuffled pixels
```
...
|---:|---:|---|---:|---:|
| 0 | 0.00 | 0.977 ± 0.002 | 0.131 | 2.3% |
| 1 | 0.04 | 0.974 ± 0.003 | 0.138 | 2.6% |
| 2 | 0.09 | 0.972 ± 0.005 | 0.144 | 2.8% |
| 3 | 0.13 | 0.968 ± 0.004 | 0.155 | 3.2% |
| 4 | 0.17 | 0.967 ± 0.002 | 0.157 | 3.3% |
| 5 | 0.22 | 0.975 ± 0.002 | 0.138 | 2.5% |
| 6 | 0.26 | 0.977 ± 0.002 | 0.130 | 2.3% |
| 7 | 0.30 | 0.981 ± 0.002 | 0.119 | 1.9% |
| 8 | 0.35 | 0.985 ± 0.001 | 0.105 | 1.5% |
| 9 | 0.39 | 0.985 ± 0.002 | 0.108 | 1.5% |
| 10 | 0.43 | 0.985 ± 0.001 | 0.105 | 1.5% |
| 11 | 0.48 | 0.986 ± 0.001 | 0.102 | 1.4% |
| 12 | 0.52 | 0.985 ± 0.001 | 0.105 | 1.5% |
| 13 | 0.57 | 0.987 ± 0.001 | 0.098 | 1.3% |
| 14 | 0.61 | 0.989 ± 0.001 | 0.092 | 1.1% |
| 15 | 0.65 | 0.988 ± 0.001 | 0.095 | 1.2% |
| 16 | 0.70 | 0.990 ± 0.001 | 0.088 | 1.0% |
| 17 | 0.74 | 0.990 ± 0.002 | 0.089 | 1.0% |
| 18 | 0.78 | 0.990 ± 0.001 | 0.086 | 1.0% |
| 19 | 0.83 | 0.990 ± 0.001 | 0.088 | 1.0% |
| 20 | 0.87 | 0.989 ± 0.000 | 0.088 | 1.1% |
| 21 | 0.91 | 0.989 ± 0.001 | 0.089 | 1.1% |
| 22 | 0.96 | 0.989 ± 0.001 | 0.088 | 1.1% |
| 23 | 1.00 | 0.988 ± 0.001 | 0.094 | 1.2% |

---

## Appendix B: additional checks, beyond the brief

These go beyond what the brief asks, and they are **not part of the reproduction**.
They were run once, for speed, because each bears on how far the result above can be
...
| **Patch embedding**: tokens before block 0 | 0.054 ± 0.063 | see B.2 |
...
### B.2 Speed appears within the first block
...
### B.4 Control values at every layer

| Layer | Ungrouped CV | Shuffled labels |
|---:|---:|---:|
| 0 | 0.976 | −0.031 |
| 1 | 0.974 | −0.036 |
| 2 | 0.974 | −0.035 |
