...
DIRECTION_DIR = REPO / "data" / "direction"
...
needs_direction_data = pytest.mark.skipif(not (DIRECTION_DIR / "manifest.jsonl").exists(),
                                          reason="direction data not present (it is gitignored)")
